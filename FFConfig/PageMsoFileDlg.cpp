...
const CString PROFILE_GROUP = _T("MSOfficeFileDlg");
...
void CPageMsoFileDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CPageMsoFileDlg, CPageMsoFileDlg::base)
...
BOOL CPageMsoFileDlg::OnInitDialog()
{
	base::OnInitDialog();
...
void CPageMsoFileDlg::OnBnClickedChkEnable()
{
...
void CPageMsoFileDlg::OnBnClickedBtnExcludes()
{
